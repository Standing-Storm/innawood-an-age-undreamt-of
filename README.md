...
Note that if you enjoy the "make literally *everything* from scratch" part of Innawood, this is going to impinge on that. It's hard to have ancient tombs, prehuman ruins, humanlike enemies in the forest, etc., without giving them at least some kind of loot that you can take from them. In addition, the progression does not go so far--most late-technology items (electronics, soldering, etc) are unavailable.
